...
export default function App() {
    ...
    return (_jsxs(AppShell, { children: [showInstallPrompt && (_jsx("div", { className: "px-4 pt-4", children: _jsx(InstallPrompt, { onInstall: handleInstall, onDismiss: handleDismiss }) })), activeTab === "sessions" && _jsx(SessionDashboard, {}), activeTab === "chat" && _jsx(ChatView, {}), activeTab === "accounts" && _jsx(AccountPanel, {}), activeTab === "settings" && _jsx(SettingsView, {})] }));
}
